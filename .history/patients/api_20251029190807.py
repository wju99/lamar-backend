...
@router.post("/providers/", response=ProviderOut)  # Handle trailing slash
...
@router.get("/providers/", response=list[ProviderOut])  # Handle trailing slash
...
@router.post("/orders/", response=OrderOut)  # Handle trailing slash
...
@router.get("/orders/", response=list[OrderOut])  # Handle trailing slash
